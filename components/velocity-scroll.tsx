...
function ParallaxText({ children, baseVelocity = 100, className }: ParallaxProps) {
    ...
    return (
        <div className="parallax w-full overflow-hidden m-0 whitespace-nowrap flex flex-nowrap">
            <motion.div className={`scroller font-bold uppercase flex whitespace-nowrap flex-nowrap ${className}`} style={{ x }}>
